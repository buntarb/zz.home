        ...
        if( images.length ){
            ...
            if( image = images.firstDatarow( ) ){
            	...
            	do{
                    ...
                    var spanElements = goog.dom.getParentElement( elements[ i ] )

							.getElementsByTagName( zz.home.enums.Const.SPAN );

                    goog.array.forEach( spanElements, function( span ){
