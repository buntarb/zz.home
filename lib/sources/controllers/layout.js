...
goog.require( 'zz.home.events.DataWasGot' );
...
zz.home.controllers.Layout =
	 ...
	 * @param {zz.net.events.WebSocketClientReady} e
	 * @private
	 */
	webSocketReadyHandler_( e ){
