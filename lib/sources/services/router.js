...
/**
 * Return boolean is menu link active now.
...
/**
 * Return boolean is nav link active now.
 * @params {string} linkId
 * @return {boolean}
 */
zz.home.services.Router.prototype.isNavLinkActive = function( linkId ){

    if( linkId.indexOf( 'tutorial' ) >= 0 ){
