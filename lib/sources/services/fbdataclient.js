...
zz.home.services.FBDataClient.prototype.getDataListener_ = function( e ){
    ...
    zz.home.services.DataConverter.getInstance( ).sortDataByStep( this.fullTutorialData_[ zz.home.enums.Languages.EN ] );
    zz.home.services.DataConverter.getInstance( ).sortDataByStep( this.fullTutorialData_[ zz.home.enums.Languages.RU ] );
...
zz.home.services.FBDataClient.prototype.getImagesListener_ = function( e ){
    ...
    if( this.fullTutorialData_[ zz.home.enums.Languages.RU ].length

        || this.fullTutorialData_[ zz.home.enums.Languages.EN ].length ){
...
zz.home.services.FBDataClient.prototype.dataIsConvertedListener_ = function( opt_e ){
    ...
    if( opt_e ){
        ...
        data = this.fullTutorialData_[ zz.home.services.Settings.getInstance( ).getUserLanguage( ) ];
    }
