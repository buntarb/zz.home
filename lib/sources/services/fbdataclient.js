...
zz.home.services.FBDataClient.prototype.dataIsConvertedListener_ = function( opt_e ){
    ...
    console.log( this.allTutorialData_ );
 ...
 * @return {Array}
 */
zz.home.services.FBDataClient.prototype.getCurrentTutorialData = function( sourceData ){
    ...
    goog.array.forEach(
        ...
        sourceData[ zz.home.services.Settings.getInstance( ).getUserLanguage( ) ],
        function( item ){
 ...
 * @return {Array}
 */
zz.home.services.FBDataClient.prototype.getTutorialMenuModelData = function( sourceData ){
...
/**
 * Send all tutorial data to server.
 */
zz.home.services.FBDataClient.prototype.sendDataToServer = function( ){

    var model = new zz.home.models.FBData( );
    var data = goog.json.serialize( this.allTutorialData_ );
    model.createLast( );
    model.lastDatarow( ).content.createLast( [ '', 'allTutorialData', data ] );

    this.wsc_.sendCommandMessage( zz.home.enums.Command.SEND_DATA_TO_SERVER, model );
};
