...
zz.home.services.FBServerApi = function( url, opt_protocol ){
    ...
    this.eventHandler_.listenWithScope(
        ...
        this.clientImagesRequestToFBListener_,
        false,
        this
    );
...
zz.home.services.FBServerApi.prototype.clientDataRequestToFBListener_ = function( e ){
    ...
    if( e ){
        ...
        dataset = new zz.net.models.MessageDataset( null, e.messageData );
    ...
    try{
        ...
        this.sendDataRequestToFB__( postOptions,
                                    arrFeed,
...
/**
 * Get album images from fb handler.
 * @param  e
 * @private
 */
zz.home.services.FBServerApi.prototype.clientImagesRequestToFBListener_ = function( e ){
    ...
    var request =  '/albums?fields=name,photos{webp_images,name},description&';
    ...
    try{
        ...
        this.sendImagesRequestToFB__( imgOptions,
                                      imgFeed,
                                      fbApiDatarow.content,
                                      fbApiDataset,
                                      e );
 ...
 * @private
 */
zz.home.services.FBServerApi.prototype.sendDataRequestToFB__ = function( postOptions,
                                                                         arrFeed,
                                                                         model,
                                                                         apiModel,
                                                                         wsEvent ){
    ...
    var postReq = https.request( postOptions, function( res ){
        ...
        self.fbDataResponseListener_( res, arrFeed, model, apiModel, wsEvent );
    } );
 ...
 * @private
 */
zz.home.services.FBServerApi.prototype.sendImagesRequestToFB__ = function( imgOptions,
                                                                           imgFeed,
                                                                           model,
                                                                           apiModel,
                                                                           wsEvent ){
    ...
    var imgReq = https.request( imgOptions, function( res ){

        self.fbImagesResponseListener_( res, imgFeed, model, apiModel, wsEvent );
    } );
 ...
 * @private
 */
zz.home.services.FBServerApi.prototype.fbDataResponseListener_ = function( res, arrFeed, model, apiModel, wsEvent ){
    ...
    res.on( "end", function( ){
        ...
        if( feed.data.length && nextPage ){
            ...
            //console.log( 'concat!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!1', arrFeed.length, arrFeed );
           ...
           self.sendDataRequestToFB__( nextOptions, arrFeed, model, apiModel, wsEvent );
            ...
            zz.home.services.DataConverter.getInstance( ).FBDataToModel( arrFeed, model );
 ...
 * @private
 */
zz.home.services.FBServerApi.prototype.fbImagesResponseListener_ = function( res, imgFeed, model, apiModel, wsEvent ){
    ...
    res.on( "end", function( ){
        ...
        imgFeed = imgFeed.concat( feed.data );


        if( feed.data.length && nextPage ){

            //console.log( 'concat!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!1', imgFeed.length, imgFeed );
            ...
            self.sendImagesRequestToFB__( nextOptions, imgFeed, model, apiModel, wsEvent );

        }else{


            zz.home.services.DataConverter.getInstance( ).FBImagesToModel( imgFeed, model );
            var dataset = new zz.net.models.MessageDataset( null, wsEvent.messageData );
            var datarow = dataset.firstDatarow( );
