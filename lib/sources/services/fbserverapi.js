 ...
 * @private
 */
zz.home.services.FBServerApi.prototype.sendDataRequestToFB_ = function( requestOptions,
                                                                         arrData,
                                                                         model,
                                                                         apiModel,
                                                                         wsEvent ){
    ...
    if( requestOptions.path.indexOf( zz.home.enums.Const.REQUEST_DOCS ) >= 0
        || requestOptions.path.indexOf( zz.home.enums.Const.REQUEST_POSTS ) >= 0 ){
    ...
    }else if( requestOptions.path.indexOf( zz.home.enums.Const.REQUEST_IMAGES ) >= 0 ){
 ...
 * @private
 */
zz.home.services.FBServerApi.prototype.fbDataResponseListener_ = function( res,
                                                                           arrData,
                                                                           model,
                                                                           apiModel,
                                                                           wsEvent ){
 ...
 * @private
 */
zz.home.services.FBServerApi.prototype.sendDataToClient_ = function( command,
                                                                     arrData,
                                                                     model,
                                                                     apiModel,
                                                                     clientSource ){
