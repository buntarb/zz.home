...
zz.home.services.FBData = function( url, opt_protocol ){
    ...
    this.wsc_.addSupportedCommand( zz.home.enums.Command.SEND_DATA_TO_SERVER );
    ...
    this.eventHandler_.listenWithScope(
        this.wsc_,
        zz.home.enums.Command.SEND_DATA_TO_SERVER,
        this.sendDataToServerListener_,
        false,
        this
    );
};
...
/**
 * Listener for data from client.
 * @param {zz.net.events.WebSocketClientMessage} e
 * @private
 */
zz.home.services.FBData.prototype.sendDataToServerListener_ = function( e ){

    var dataset = new zz.net.models.MessageDataset( null, e.messageData );
    var datarow = dataset.firstDatarow( );
    var data = goog.json.serialize( goog.json.parse( datarow.data )[ 0 ][ 2 ][ 0 ][ 2 ] );
    fs.writeFile( zz.home.enums.Const.DATA_FILE_PATH, data );
};
